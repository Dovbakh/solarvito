...
namespace Solarvito.Migrations.Migrations
{
    ...
    [Migration("20221219214421_Identity_Contact_columns2")]
    partial class Identity_Contact_columns2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solarvito.Domain.Advertisement", b =>
                {
                    b.HasOne("Solarvito.Domain.ApplicationUser", "ApplicationUser")
            ...
            modelBuilder.Entity("Solarvito.Domain.Comment", b =>
                {
                    ...
                    b.HasOne("Solarvito.Domain.ApplicationUser", "Authorr")
                        .WithMany("CommentsBy")
                    ...
                    b.HasOne("Solarvito.Domain.ApplicationUser", "Userr")
                        .WithMany("CommentsFor")
